...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-77.697609, -12.242545, -76.765054, -11.641672], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([-77.697609, -12.242545, -76.765054, -11.641672], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GEOLOGIA DEL DEPARTAMENTO DEL CALLAO</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (23 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@ Anderson J. Cruzado H';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_GEOLOGIAaDELCALLAO_1,
    colName: 'SIMBOLO_',
    zoom: 10,
    collapsed: true,
    map: map
